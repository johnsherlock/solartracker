...
6. After confirmation, ensure you are on `main` (`git checkout main && git pull origin main`), then create a branch for the story from `main` (e.g. `stories/P-021`) and switch to it
